...
|------|-----|-------------------|---------|---------------------|
| **Interface** | `[interface]` | **Component** | Define system boundaries and function signatures. | Typed code block (TypeScript/Python), Fixtures table, **Rationale**. |
...
| **Script** | `[interface]` | **Script** | Define input/output for automated tools that guide Agents. | CLI signature, Output Format, "Next Step" examples, **Rationale**. |
