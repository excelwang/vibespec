...
vibespecs 里的 **L1 Contracts** 就是用来定义这些承诺的。我们不需要关心商家是怎么发货的（是顺丰还是圆通），我们只关心“我付钱，我要货”这个承诺是否兑现。
...
在 vibespecs 中，我们定义这些“铁律”，让计算机疯狂地随机测试系统。
...
它的目的就是为了找出：“有没有某一种特定的按键顺序，能让游戏崩溃？”。这就是 vibespecs 帮你做的事情：**它可以自动生成成千上万种操作序列，试图找出那你永远想不到的 Bug。**
