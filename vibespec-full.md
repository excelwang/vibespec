# VIBE-SPECS SYSTEM CONTEXT (v2.0.0)
...
> **Annotation Legend**:
> - `[system]`: Implementation details (Do not change unless you are the System Architect).
> - `[standard]`: Design patterns and rules (Follow these strictures).
